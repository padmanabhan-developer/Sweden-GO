...
<div class="opret_tur">
                  <div class="opret_tur_left">
                        ...
                        <div class="row11">
                           ...
                           <input class="button24" type="submit" id="edit-submit4" name="op" value="UPPRÄTTA TUR" disabled>
                        </div><!--close row11-->
                ...
                <?php print $content['mc3']; ?>
                    ...
                    <?php print $content['mc7']; ?>
                        <label id="kanikkebookes">Cykeln ingår i den angivna tidsperioden.</label>
...
//   $("#edit-field-tur-beboer-und").addClass('list3');
 ...
 //$("#edit-field-testlokation-und option").css("display","none");
   ...
   // $('#edit-field-testlokation-und option:first').text('Välj lokation');
     $("<option value='0' disabled>Välj plats</option>").insertBefore($('#edit-field-testlokation-und option:first'));
...
<?
   ...
   {
   ?>
    $("#edit-field-tur-kommentar-und-0-value").attr("placeholder", "GE KOMMENTARER OM TUR HÄR");
   <?
   }
   ?>

 $('#edit-field-tur-beboer-und option:first').text('Välj passagerare');
...
$("#edit-field-tur-dato-und-0-value-timepicker-popup-1").val("Välj tid");
$("#edit-field-tur-dato-und-0-value2-timepicker-popup-1").val("Välj tid");
...
$("#edit-submit4").css("background-color","#838383");
 foo2();
 $.get("http://sweden.gobooking.bike/sites/all/themes/cua/panels/layouts/cua_oprettur/test.php?id=" + $("#edit-field-testlokation-und").val() + "&da=" + $("#edit-field-tur-dato-und-0-value-datepicker-popup-0").val() + "&rnd=" + Math.random() , function(data) {
 $("#syvtid").html(data);

 });
$.get("http://sweden.gobooking.bike/sites/all/themes/cua/panels/layouts/cua_oprettur/test2.php?id=" + $("#edit-field-testlokation-und").val() + "&da=" + $("#edit-field-tur-dato-und-0-value-datepicker-popup-0").val() + "&t1=" + $("#edit-field-tur-dato-und-0-value-timepicker-popup-1").val() + "&rnd=" + Math.random() , function(data) {
 $("#syvtid").html(data);
 });
...
$("#edit-submit4").css("background-color","#838383");
$("#kanikkebookes").css("display","block");
 $.get("http://sweden.gobooking.bike/sites/all/themes/cua/panels/layouts/cua_oprettur/test2.php?id=" + $("#edit-field-testlokation-und").val() + "&da=" + $("#edit-field-tur-dato-und-0-value-datepicker-popup-0").val() + "&t1=" + $("#edit-field-tur-dato-und-0-value-timepicker-popup-1").val() + "&t2=" + $("#edit-field-tur-dato-und-0-value2-timepicker-popup-1").val() + "&rnd=" + Math.random(), function(data) {
 $("#syvtid2").html(data);
 });
}
...
// $("#syvtid2").html(data);
 ...
 $("#syvtid").html(data);
  ...
  $.get("http://sweden.gobooking.bike/sites/all/themes/cua/panels/layouts/cua_oprettur/test4.php?id=" + $("#edit-field-testlokation-und").val() + "&rnd=" + Math.random(), function(data) {
 $("#syvtid3").html(data);
 });
